...
@section('content-wrapper')
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ URL::to('data-penyakit/' . $dataPenyakit->id_penyakit) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('solusi_penyakit') is-invalid @enderror" id="solusi_penyakit"
                            name="solusi_penyakit" rows="3" placeholder="Masukkan Solusi Penyakit...">{{ old('solusi_penyakit', $dataPenyakit->solusi_penyakit) }}</textarea>

    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="{{ URL::to('data-riwayat-kasus/create') }}" class="btn btn-primary mb-3">
                ...
                <table class="table table-bordered" id="dataTable" style="width: 100%;">
                    ...
                    <tbody class="bg-secondary bg-gradient text-white">
                        @php
                            $i = 1;
                        @endphp
                        @foreach ($dataRiwayatKasus as $riwayatkasus)
                            <tr class="text-white">
                                <td class="align-middle text-center">{{ $i }}</td>
                                <td class="align-middle text-center">{{ $riwayatkasus->kode_kasus }}</td>
                                <td class="align-middle">
                                    <ul>
                                        @foreach (json_decode($riwayatkasus->array_gejala) as $gejala)
                                            @foreach ($dataGejala as $gejalaFetch)
                                                @if ($gejala == $gejalaFetch->kode_gejala)
                                                    <li>
                                                        <p style="text-align: justify;">
                                                            {{ $gejalaFetch->nama_gejala }}
                                                        </p>
                                                    </li>
                                                @endif
                                            @endforeach
                                ...
                                <td class="align-middle text-center">
                                    ...
                                    <form action="{{ URL::to('data-riwayat-kasus/' . $riwayatkasus->id_kasus) }}"
